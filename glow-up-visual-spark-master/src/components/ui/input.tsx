    ...
    return (
      <input
        ...
        className={cn(
          ...
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/70 focus-visible:ring-offset-1 focus-visible:border-blue-400 transition-colors duration-200",
